...
def parseCSV(filePath, quiz_id):
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS QUESTIONS (quiz_id varchar(100) NOT NULL, q_desc varchar(100) NOT NULL, option_one varchar(100) NOT NULL, option_two varchar(100) NOT NULL, option_three varchar(100) NOT NULL, option_four varchar(100) NOT NULL, correct_option varchar(100) NOT NULL, q_marks int NOT NULL, CONSTRAINT fk_questions FOREIGN KEY (quiz_id) REFERENCES QUIZ(quiz_id) ON DELETE CASCADE ON UPDATE CASCADE);")
...
def createQuiz():
    ...
    # Create Quiz table
    cursor.execute("CREATE TABLE IF NOT EXISTS QUIZ(quiz_id varchar(100) NOT NULL, quiz_name varchar(100) NOT NULL, total_marks int, primary key (quiz_id));")
    con.commit()
